...
dt <- read_xls(here("dev/data/sp_taste/", "Home tasting DATA_tricot study.xls"),
...
# remove NAs in package vars
keep <- apply(dt[,paste0("package_item_", LETTERS[1:3])], 1, function(x){
  !any(is.na(x))
})
